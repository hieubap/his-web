...
import { Checkbox, Col, Input, Button, Modal, Form } from "antd";
    ...
    },
    {
      title: (
        <HeaderSearch
          ...
          search={
            <Input
              placeholder="Tìm mã nhóm vật tư"
              onChange={(e) => {
    ...
    },
    {
      title: (
        <HeaderSearch
          ...
          search={
            <Input
              placeholder="Tìm tên nhóm vật tư"
              onChange={(e) => {
      ...
      <HomeWrapper title="Danh mục">
        ...
        >
          <TableWrapper
            ...
            buttonHeader={
              checkRole([ROLES["DANH_MUC"].NHOM_VAT_TU_THEM])
                ? [
                    {
                      title: "Thêm mới",
        ...
        {!state.showFullTable && (
          ...
          >
            <CreatedWrapper
              ...
              onOk={handleAdded}
              okText="Lưu"
              roleSave={[ROLES["DANH_MUC"].NHOM_VAT_TU_THEM]}
              roleEdit={[ROLES["DANH_MUC"].NHOM_VAT_TU_SUA]}
              editStatus={editStatus}
            >
              <fieldset
                disabled={
                  editStatus
                    ? !checkRole([ROLES["DANH_MUC"].NHOM_VAT_TU_SUA])
                    : !checkRole([ROLES["DANH_MUC"].NHOM_VAT_TU_THEM])
                }
              >
                <Form
                ...
                >
                  <Form.Item
                    ...
                    rules={[
                      ...
                      },
                      {
                        max: 20,
                        message:
                          "Vui lòng nhập mã nhóm vật tư không quá 20 ký tự!",
                      },
                      {
                        whitespace: true,
                        message: "Vui lòng nhập mã nhóm vật tư!",
                  ...
                  >
                    <Input
                      ...
                      placeholder="Vui lòng nhập mã nhóm vật tư"
                      ref={refAutoFocus}
                    />
                  </Form.Item>
                  <Form.Item
                    ...
                    rules={[
                      ...
                      },
                      {
                        max: 1000,
                        message:
                          "Vui lòng nhập tên nhóm vật tư không quá 1000 ký tự!",
                      },
                      {
                        whitespace: true,
                        message: "Vui lòng nhập tên nhóm vật tư!",
                  ...
                  >
                    <Input
                      className="input-option"
                      placeholder="Vui lòng nhập tên nhóm vật tư"
                    />
                  </Form.Item>
                  {editStatus && (
...
const mapDispatchToProps = ({
  nhomVatTu: { getListSuppliesGroup, createOrEdit, onDelete, updateData },
}) => ({
  getListSuppliesGroup,
  createOrEdit,
  onDelete,
...
export default connect(mapStateToProps, mapDispatchToProps)(NhomVatTu);
