...
const LoaiBenhAn = (props) => {
  ...
  useEffect(() => {
    ...
    getListLoaiBenhAn(params);
  }, []);

  useEffect(() => {
    const data = listLoaiBenhAn.map((item, index) => {
      return { ...item, action: item, stt: page * size + index + 1 };
    });
    setData(data);
  }, [listLoaiBenhAn, page, size]);
      ...
      <HomeWrapper title="Danh mục">
        ...
        >
          <TableWrapper
            ...
            buttonHeader={
              checkRole([ROLES["DANH_MUC"].LOAI_BA_THEM]) && [
                {
                  title: "Thêm mới",
          ...
          >
            ...
            >
              <FormWraper
                disabled={
                  editStatus
                    ? !checkRole([ROLES["DANH_MUC"].LOAI_BA_SUA])
                    : !checkRole([ROLES["DANH_MUC"].LOAI_BA_THEM])
                }
                form={form}
                layout="vertical"
                ...
                <Form.Item
                  ...
                  rules={[
                    ...
                    },
                    {
                      max: 20,
                      message:
                        "Vui lòng nhập mã loại bệnh án không quá 20 ký tự!",
                    },
                    {
                      whitespace: true,
                      message: "Vui lòng nhập mã loại bệnh án!",
                ...
                <Form.Item
                  ...
                  rules={[
                    ...
                    },
                    {
                      max: 1000,
                      message:
                        "Vui lòng nhập tên loại bệnh án không quá 1000 ký tự!",
                    },
                    {
                      whitespace: true,
                      message: "Vui lòng nhập tên loại bệnh án!",
