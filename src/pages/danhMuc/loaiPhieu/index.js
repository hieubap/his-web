...
import ThongTinChiTietLoaiPhieu from "./ThongTinChiTietLoaiPhieu";
  ...
  const onShowModalConfirmXoaPhieu = (item) => () => {
    ...
    refConfirmXoaRow.current &&
      refConfirmXoaRow.current.show(
        {
          title: "Cảnh báo",
          content: `Xóa mã loại phiếu ${item?.ma}?`,
          cancelText: "Đóng",
          okText: "Xóa",
    ...
    },
    {
      title: (
        <HeaderSearch
          ...
          search={
            <Input
              placeholder="Tìm tên loại phiếu"
...
export default connect(mapStateToProps, mapDispatchToProps)(LoaiPhieu);
