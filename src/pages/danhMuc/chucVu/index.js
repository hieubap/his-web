...
const ChucVu = (props) => {
  ...
  useEffect(() => {
    ...
    getListChucVu(params);
  }, []);

  useEffect(() => {
    const data = listChucVu.map((item, index) => {
      return { ...item, action: item, stt: page * size + index + 1 };
    });
    setData(data);
  }, [listChucVu, page, size]);
  ...
  const hanldeHiddenCancel = () => {
    if (editStatus) {
      return !checkRole([ROLES["DANH_MUC"].CHUC_VU_SUA]);
    } else {
      return !checkRole([ROLES["DANH_MUC"].CHUC_VU_THEM]);
    }
  };
      ...
      <HomeWrapper title="Danh mục">
        ...
        >
          <TableWrapper
            ...
            buttonHeader={
              checkRole([ROLES["DANH_MUC"].CHUC_VU_THEM])
                ? [
                    {
                      title: "Thêm mới",
          ...
          >
            ...
            >
              <FormWraper
                disabled={
                  editStatus
                    ? !checkRole([ROLES["DANH_MUC"].CHUC_VU_SUA])
                    : !checkRole([ROLES["DANH_MUC"].CHUC_VU_THEM])
                }
                form={form}
                layout="vertical"
                ...
                <Form.Item
                  ...
                  rules={[
                    ...
                    },
                    {
                      max: 1000,
                      message:
                        "Vui lòng nhập tên chức vụ không quá 1000 ký tự!",
                    },
                    {
                      whitespace: true,
                      message: "Vui lòng nhập tên chức vụ!",
