...
const LoaiCapCuu = (props) => {
  ...
  useEffect(() => {
    ...
    getListLoaiCapCuu(params);
  }, []);

  useEffect(() => {
    const data = listLoaiCapCuu.map((item, index) => {
      return { ...item, action: item, stt: page * size + index + 1 };
    });
    setData(data);
  }, [listLoaiCapCuu, page, size]);
                ...
                <Form.Item
                  ...
                  rules={[
                    ...
                    },
                    {
                      max: 20,
                      message:
                        "Vui lòng nhập mã loại cấp cứu không quá 20 ký tự!",
                    },
                    {
                      whitespace: true,
                      message: "Vui lòng nhập mã loại cấp cứu!",
                ...
                <Form.Item
                  ...
                  rules={[
                    ...
                    },
                    {
                      max: 1000,
                      message:
                        "Vui lòng nhập tên loại cấp cứu không quá 1000 ký tự!",
                    },
                    {
                      whitespace: true,
                      message: "Vui lòng nhập tên loại cấp cứu!",
