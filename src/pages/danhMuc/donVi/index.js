...
const Unit = (props) => {
  ...
  useEffect(() => {
    const data = listDonVi.map((item, index) => {
      ...
      <HomeWrapper title="Danh mục">
        ...
        >
          <TableWrapper
            ...
            buttonHeader={
              checkRole([ROLES["DANH_MUC"].CO_QUAN_THEM])
                ? [
                    {
                      title: "Thêm mới",
          ...
          >
            ...
            >
              <FormWraper
                disabled={
                  editStatus
                    ? !checkRole([ROLES["DANH_MUC"].CO_QUAN_SUA])
                    : !checkRole([ROLES["DANH_MUC"].CO_QUAN_THEM])
                }
                form={form}
                layout="vertical"
                ...
                <Form.Item
                  ...
                  rules={[
                    ...
                    },
                    {
                      max: 20,
                      message:
                        "Vui lòng nhập mã cơ quan đơn vị không quá 20 ký tự!",
                    },
                    {
                      whitespace: true,
                      message: "Vui lòng nhập mã cơ quan đơn vị!",
                ...
                <Form.Item
                  ...
                  rules={[
                    ...
                    },
                    {
                      max: 1000,
                      message:
                        "Vui lòng nhập tên cơ quan đơn vị không quá 1000 ký tự!",
                    },
                    {
                      whitespace: true,
                      message: "Vui lòng nhập tên cơ quan đơn vị!",
