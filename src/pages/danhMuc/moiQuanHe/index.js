...
const MoiQuanHe = (props) => {
  ...
  useEffect(() => {
    ...
    const params = { active: "", page: PAGE_DEFAULT, size: SIZE_DEFAULT, sort };
    getListQuanHe(params);
  }, []);

  useEffect(() => {
    const data = listQuanHe.map((item, index) => {
      return { ...item, action: item, stt: page * size + index + 1 };
    });
    setData(data);
  }, [listQuanHe, page, size]);
  ...
  const onPageChange = (page) => {
    const params = { page: page - 1, size, active: "" };
    updateData(params);
    getListQuanHe({
      ...params,
      ...dataSearch,
                ...
                <Form.Item
                  ...
                  rules={[
                    ...
                    },
                    {
                      max: 20,
                      message:
                        "Vui lòng nhập mã mối quan hệ không quá 20 ký tự!",
                    },
                    {
                      whitespace: true,
                      message: "Vui lòng nhập mã mối quan hệ!",
                ...
                <Form.Item
                  ...
                  rules={[
                    ...
                    },
                    {
                      max: 1000,
                      message:
                        "Vui lòng nhập tên mối quan hệ không quá 1000 ký tự!",
                    },
                    {
                      whitespace: true,
                      message: "Vui lòng nhập tên mối quan hệ!",
