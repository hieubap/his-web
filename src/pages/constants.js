...
const KeDichVu = React.lazy(() => import("./tiepDon/keDichVu"));
const Guide = React.lazy(() => import("./guide"));
const Therapy = React.lazy(() => import("./danhMuc"));
...
// Page home
const PageHome = React.lazy(() => import("./home/pageHome.js"));
const PageCategory = React.lazy(() => import("./home/pageCategory.js"));
const PageXN = React.lazy(() => import("./home/subPage/pageXN"));
const PageTN = React.lazy(() => import("./home/subPage/pageThuNgan"));
const PageQuanTri = React.lazy(() => import("./home/subPage/pageQuanTri"));
const PageThietLap = React.lazy(() => import("./home/subPage/pageThietLap"));
const PageKho = React.lazy(() => import("./home/subPage/pageKho"));
const PageCDHA = React.lazy(() => import("./home/subPage/pageCDHA"));
const PageHoSoBenhAn = React.lazy(() =>
  import("./home/subPage/pageHoSoBenhAn")
);
const PageTheoDoiDieuTri = React.lazy(() =>
  import("./home/subPage/pageTheoDoiDieuTri")
);
const PageKySo = React.lazy(() => import("./home/subPage/pageKySo"));
const PageBaoCao = React.lazy(() => import("./home/subPage/pageBaoCao"));

//admin
const PhuongThucTT = React.lazy(() => import("./danhMuc2/phuongThucTT"));
const ChePhamMau = React.lazy(() => import("./danhMuc/chePhamMau"));
const DiaChiHanhChinh = React.lazy(() => import("./danhMuc2/diaChiHanhChinh"));
...
const ThucHienGBPVS = React.lazy(() =>
  import("./xetNghiem/ThucHienGBPVS")
);
...
const ThietLapChonKho = React.lazy(() => import("./kho/thietLapChonKho"));
...
const QmsDocChanDoanHinhAnh = React.lazy(() => import("./qms/qmsDoc/chanDoanHinhAnh"));
...
const therapyAdmin = {
  ...
  pageCategory: {
    component: Page(PageCategory, []),
    accessRoles: [],
    path: "/danh-muc",
    exact: true,
  },
  pageXN: {
    component: Page(PageXN, []),
    accessRoles: [],
    path: "/xet-nghiem",
    exact: true,
  },
  pageTN: {
    component: Page(PageTN, []),
    accessRoles: [],
    path: "/thu-ngan",
    exact: true,
  },
  pageQuanTri: {
    component: Page(PageQuanTri, []),
    accessRoles: [],
    path: "/quan-tri",
    exact: true,
  },
  pageThietLap: {
    component: Page(PageThietLap, []),
    accessRoles: [],
    path: "/thiet-lap",
    exact: true,
  },
  ...
  homePage: {
    component: Page(PageHome, ["home_trangChu"]),
    accessRoles: [],
    path: "/trang-chu",
    exact: true,
  },
...
const thuNganPages = {
  ...
  chitietPhieuYeuCauHoan: {
    ...
    accessRoles: [],
    path: "/thu-ngan/chi-tiet-phieu-hoan-tra/:maHoSo/:phieuHoanTraId/:nbDotDieuTriId",
    exact: true,
  },
};

const xetNghiemPages = {
  layMauXetNghiem: {
...
const hoSoBenhAnPages = {
  hoSoBenhAn: {
    component: Page(PageHoSoBenhAn, []),
    accessRoles: [],
    path: "/ho-so-benh-an",
    exact: true,
  },
...
const theoDoiDieuTriPages = {
  theoDoiDieuTri: {
    component: Page(PageTheoDoiDieuTri, []),
    accessRoles: [],
    path: "/theo-doi-nguoi-benh",
    exact: true,
  },
