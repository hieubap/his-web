...
const ReportSummary = (props) => {
  ...
  return (
    <Main>
      <Page
        header={<PageHeader leftArea={"BÁO CÁO TÌNH HÌNH CẤP PHÁT THUỐC"} />}
      >
        <Spin spinning={props.isLoadingDetailReport}>
...
const mapState = (state) => ({
  ...
  isLoadingDetailReport: state.drugAllocation.isLoadingDetailReport || false,
});

const mapDispatch = ({
  department: { getAllDepartments },
  room: { getAllRoomsAdmin },
  drugAllocation: { onExportDetailReport, updateData },
}) => ({
  getAllDepartments,
  getAllRoomsAdmin,
  onExportDetailReport,
