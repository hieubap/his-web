  ...
  return (
    <Main>
      <HomeWrapper title="Báo cáo">
        <Wrapper title="K01.1. Báo cáo nhập theo Nhà cung cấp" action={action}>
          {state.blobUrl ? (
            ...
            <div>
              ...
              <Row>
                <Col md={6} xl={6} xxl={6}>
                  <div className="item-select">
                    <Checkbox>Hiển thị Kí hiệu hóa đơn</Checkbox>
                  </div>
                </Col>
                <Col md={6} xl={6} xxl={6}>
                  <div className="item-select">
                    <Checkbox>Hiển thị HSD</Checkbox>
                  </div>
                </Col>
                <Col md={12} xl={12} xxl={12}>
                  <div className="item-select">
                    <Checkbox>Hiển thị phân nhóm thuốc</Checkbox>
                  </div>
                </Col>
                <Col md={6} xl={6} xxl={6}>
                  <div className="item-select">
                    <Checkbox>Hiển thị ĐVT</Checkbox>
                  </div>
                </Col>
                <Col md={6} xl={6} xxl={6}>
                  <div className="item-select">
                    <Checkbox>Hiển thị số quyết định</Checkbox>
                  </div>
                </Col>
                <Col md={12} xl={12} xxl={12}>
                  <div className="item-select">
                    <Checkbox>Hiển thị số phiếu</Checkbox>
                  </div>
                </Col>
              </Row>
            </div>
