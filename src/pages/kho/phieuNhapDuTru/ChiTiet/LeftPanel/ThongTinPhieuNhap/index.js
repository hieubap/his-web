      ...
      <div className="body-info">
        <Row className="info-full">
          ...
          <Col sm={24} md={24} xl={24} xxl={24}>
            <div className="title" style={{ fontSize: "1.1rem" }}>Thông tin phiếu nhập</div>
          </Col>
          {/* </div> */}
          <Col sm={24} md={24} xl={24} xxl={24}>
            <Row>
              <Col sm={6} md={6} xl={6} xxl={6} className="info">
                <Row className="">
                  <div
                    ...
                    style={{ marginRight: 35 }}>Kho xuất: </div>
              ...
              <Col sm={6} md={6} xl={6} xxl={6} className="info">
                <Row className="">
                  <div className="title last" style={{ marginRight: 20 }}>Tháng dự trù: </div>
              ...
              <Col sm={6} md={6} xl={6} xxl={6} className="info">
                <Row className="">
                  <div className="title last" style={{ marginRight: 20 }}>Số phiếu : </div>
                  <div className="detail last">
                    {thongTinPhieuNhap?.soPhieu}
                  </div>
                </Row>
              </Col>
              <Col sm={6} md={6} xl={6} xxl={6} className="info">
                <Row className="">
                  <div className="title last" style={{ marginRight: 20 }}>Người tạo phiếu : </div>
                  <div className="detail last">
            ...
            <Row>
              <Col sm={6} md={6} xl={6} xxl={6} className="info">
                <Row className="">
                  <div className="title" style={{ marginRight: 35 }}>Hình thức nhập : </div>
                  <div className="detail">
              ...
              <Col sm={6} md={6} xl={6} xxl={6} className="info">
                <Row className="">
                  <div className="title last" style={{ marginRight: 20 }}>Kho : </div>
                  <div className="detail last">
                    {thongTinPhieuNhap?.kho?.ten}
                  </div>
                </Row>
              </Col>
              {/* <Col sm={6} md={6} xl={6} xxl={6} className="info">
              ...
              <Col sm={6} md={6} xl={6} xxl={6} className="info">
                <Row className="">
                  <div className="title last" style={{ marginRight: 20 }}>Ghi chú : </div>
                  <div className="detail last">
                    {thongTinPhieuNhap?.ghiChu}
                  </div>
                </Row>
              </Col>
            </Row>
