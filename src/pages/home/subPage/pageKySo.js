...
const PageKySo = (props) => {
  ...
  const onSearch = (value) => {
    ...
    const dataSearch = ListKySo?.filter(
      (option) =>
  ...
  return (
    <Layout>
      <Mainfunc bgPageFunc={require("assets/images/pagehome/bgKySo.png")}>
        <div className="list-category list-func">
          <div className="list-func--search">
            ...
            <div className="list-func--cateogry">
              <img
                src={require("assets/images/pagehome/icKySo.png")}
                alt="iSofh"
              />
              <span>Ký số</span>
            </div>
...
export default connect(mapState, mapDispatch)(PageKySo);
