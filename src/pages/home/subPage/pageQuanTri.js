...
const QuanTri = (props) => {
  ...
  const onSearch = (value) => {
    ...
    const dataSearch = ListQuanTriHeThong?.filter(
      (option) =>
  ...
  return (
    <Layout>
      <Mainfunc bgPageFunc={require("assets/images/pagehome/bgQuanTriHeThong.png")}>
        <div className="list-category list-func">
          <div className="list-func--search">
            ...
            <div className="list-func--cateogry">
              <img
                src={require("assets/images/pagehome/icQuanTriHeThong.png")}
                alt="iSofh"
              />
...
export default connect(mapState, mapDispatch)(QuanTri);
