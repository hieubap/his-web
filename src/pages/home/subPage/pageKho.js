...
const Kho = (props) => {
  ...
  const onSearch = (value) => {
    ...
    const dataSearch = ListKho?.filter(
      (option) =>
  ...
  return (
    <Layout>
      <Mainfunc bgPageFunc={require("assets/images/pagehome/bgKho.png")}>
        <div className="list-category list-func">
          <div className="list-func--search">
            ...
            <div className="list-func--cateogry">
              <img
                src={require("assets/images/pagehome/icKho.png")}
                alt="iSofh"
              />
              <span>Kho</span>
            </div>
...
export default connect(mapState, mapDispatch)(Kho);
