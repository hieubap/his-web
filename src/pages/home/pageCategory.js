...
const Index = (props) => {
  ...
  const [state, _setState] = useState({
    data: [],
    searchTerm: "",
    // data: ListContentLeftFunc?.filter((option) => {
  ...
  const onSearch = (value) => {
    ...
    // let dataSearch = ListContentLeftFunc?.filter((option) => {
  ...
  const mappingCategory = (searchTerm = "") => {
    ...
    let subCategories = ListContentLeftFunc?.filter((option) => {
        ...
        <div className="list-category list-func">
          <div className="list-func--search">
            ...
            <div className="list-func--cateogry">
              <img src={require("assets/images/pagehome/icDMChucNang.png")} alt="iSofh" />
              <span>Danh mục</span>
            </div>
