...
const WebcamModal = (props) => {
    const { avatar, modalActions, type, title, onClose } = props;
        ...
        <Main
                    ...
                    <div className="action-capture">
                        <div className="row">
                            ...
                            <div className="col-md-4 text-right">
                                ...
                                <Button className="btn-print text-uppercase" onClick={() => uploadImage()} > Lưu lại</Button>
                            </div>
                        </div>
                    </div>
                </div >
            ...
            <div className="webcam-inner">
                ...
                <MainScreen className="video-screen">
                    <Camera
                        onTakePhoto={dataUri => selectImage(dataUri, true)}
