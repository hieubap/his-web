...
export default {
  search: ({ page = 0, active, sort, size = 500, ...payload }) => {
    return new Promise((resolve, reject) => {
      client
        .get(
          combineUrlParams(`${dataPath}${DM_KHO}`, {
            page: page + "",
            active,
            sort,
            size,
  ...
  searchTongHop: ({ page = 0, active, sort, size = 500, ...payload }) => {
    return new Promise((resolve, reject) => {
      client
        .get(
          combineUrlParams(`${dataPath}${DM_KHO}/tong-hop`, {
            page: page + "",
            active,
            sort,
            size,
