...
export const DM_XA_TONG_HOP = "/dm-xa-phuong/tong-hop";
export const SSO_LOGIN = "/auth/sso-login";
export const AUTH_LOGIN = "/auth/login";
export const AUTH_REFRESH = "/auth/refresh";
export const DM_DV_CAP3_TONG_HOP = "/dm-nhom-dich-vu-cap3/tong-hop";
...
export const UTILS = "/utils/enums";
// categories
...
export const DM_PHUONG_PHAP_GAY_ME = "/dm-phuong-phap-gay-me";
...
export const DM_NGUYEN_NHAN_NHAP_VIEN = "/dm-nguyen-nhan-nhap-vien";
...
export const DM_GOI_DICH_VU = "/dm-goi-dv";
...
export const NB_PHIEU_THU_TT = "/nb-phieu-thu/thanh-toan";
export const NB_PHIEU_THU_TONG_HOP = "/nb-phieu-thu/tong-hop";
export const NB_PHIEU_THU_THONG_KE = "/nb-phieu-thu/thong-ke/so-luong";
export const NB_DICH_VU = "/nb-dich-vu";
export const NB_TACH_PHIEU_THU = "/nb-phieu-thu/tach-phieu-thu";
...
export const PHIEU_KHAM_BENH = NB_DV_KHAM_BENH + "/phieu-kham-benh";
export const PHIEU_KHAM_XET_NGHIEM = NB_DICH_VU_XET_NGHIEM + "/phieu-chi-dinh";
export const PHIEU_KHAM_CDHA = "/nb-dv-cdha-tdcn-pt-tt/phieu-chi-dinh";
...
export const TON_KHO = "/kho-ton-kho";
export const NB_DV_THUOC = "/nb-dv-thuoc";
export const KHO_TON_KHO = "/kho-ton-kho";
export const CAM_KET_DIEU_TRI_COVID =
  NB_DOT_DIEU_TRI + "/phieu-cam-ket-dtri-covid-tu-xa";
...
export const NB_DV_HOAN = "/nb-phieu-doi-tra";

//ky va in

export const GIU_THE_BHYT = NB_DOT_DIEU_TRI + "/giay-giu-the-bhyt";
